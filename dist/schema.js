import {normalizeListOrder} from './list-order.js?v=20260920-contact1';
...
contact:[["email","Email","email"],["phone","Telephone","text"],["address","Postal address","textarea"],["room","Building / room","text"],["transport","Getting here","textarea"],["visiting","Visit information","textarea"],["inquiry","General inquiries / collaboration","textarea"],["mapQuery","Google Maps location / query","text",false,"Enter the building and street address, for example: 한국전자통신연구원 3동, 대전광역시 유성구 가정로 218. The map uses this location; when blank, it uses Building / room and Postal address."],["mapUrl","Google Maps link (optional)","url",false,"Optional verified map sharing link for Open in Google Maps. Leave blank to open the map location above."],["isExample","Mark as an example","checkbox",false,"Turn this off after replacing the example with real information."]]
};
