import {sections,fields,singleSections,escapeHTML as e,validateContent,newRecord,destinationOptions,enumLabel} from './schema.js?v=20260920-contact1';
import {elementPages} from './pagination.js?v=20260920-contact1';
import {renderLiveCard} from './live-preview.js?v=20260920-contact1';
import {upsertImported,doiValue} from './publication-data.js?v=20260920-contact1';
import {lookupDOI,normalizeDOI,mergeDOIFields} from './doi-import.js?v=20260920-contact1';
import {orderRecords} from './list-order.js?v=20260920-contact1';
import {authorEntries,normalizeAuthorRoles,updateAuthorRole,renderAuthors,authorLegend} from './author-roles.js?v=20260920-contact1';
...
document.querySelector('#document-file').addEventListener('change',async event=>{
 ...
 try{const {importDocument}=await import('./document-import.js?v=20260920-contact1');for(const [index,file] of files.entries()){
